"""Derived from http://bryanhelmig.com/python-crossword-puzzle-generator/ with adjustments for Python 3 compatability and case-specific usage.
"""
...
if __name__ == '__main__':
    ...
    a = Crossword(25, 25, '-', 5000, word_list)
